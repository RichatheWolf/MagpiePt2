...
public class Magpie4
{
    ...
    public String getResponse(String statement) {
        ...
        // Responses which require transformations
            ...
            response = transformIWantToStatement(statement, "I want to");
        }
        else if (findKeyword(statement, "I want", 0) >= 0) {
            response = transformIWantToStatement(statement, "I want");
        }
        else {
            ...
            /* else if (position >= 0 && findKeyword(statement, "I", position) >= 0) {
                response = transformYouMeStatement(statement);
            }
             */
            else {
     ...
     */
    private String transformIWantToStatement(String statement, String goal){
        ...
        int position = findKeyword (statement, goal, 0);
        String restOfStatement = statement.substring(position + goal.length()).trim();
